...
class InstructorForm(forms.Form):
    ...
    tipo_documento = forms.ChoiceField(choices=Instructor.TIPO_DOCUMENO_CHOICES, label="Tipo de Documento", help_text="Seleccione el tipo de documento del instructor.")
    ...
    nivel_educativo = forms.ChoiceField(choices=Instructor.NIVEL_EDUCACION_CHOICES, label="Nivel Educativo", help_text="Seleccione el nivel educativo del instructor.")
    ...
    def clean(self):
        ...
        if not documento_identidad or not nombre or not apellido:
