...
class ProgramaForm(forms.Form):
    ...
    descripcion = forms.CharField(max_length=200, widget=forms.Textarea, required=False, label="Descripción", help_text="Ingrese la descripción del programa de formación.")
    competencias = forms.CharField(max_length=200, widget=forms.Textarea, required=False,label="Competencias a Desarrollar", help_text="Ingrese las competencias a desarrollar del programa de formación.")
    perfil_egreso = forms.CharField(max_length=200, widget=forms.Textarea, required=False,label="Perfil de Egreso", help_text="Ingrese el perfil de egreso del programa de formación.")
    requisitos_ingreso = forms.CharField(max_length=200, widget=forms.Textarea, required=False,label="Requisitos de Ingreso", help_text="Ingrese los requisitos de ingreso del programa de formación.")
